...
"""
    search_get(q; item_type::String="track,artist", include_external::String="",
                    limit=20, market="", offset::Int64=0)
...
```
"""
function search_get(q; item_type::String="track,artist", include_external::String="",
                    limit=20, market="", offset::Int64=0)
